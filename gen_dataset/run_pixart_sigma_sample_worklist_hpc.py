#!/usr/bin/env python3
"""Recover PixArt-Sigma samples from an explicit prompt/sample worklist."""
...
def main():
    ...
    print(
        f"[pixart-sigma-sample-worklist] worklist={args.worklist} samples={len(rows)} "
    ...
    with open(meta_path, "a", encoding="utf-8") as meta_file:
        for row in tqdm(shard_rows, desc="PixArt-Sigma sample worklist"):
